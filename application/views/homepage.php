        ...
        <section class="section-1">
            <div class="img1">
                <div class="signup">
                    ...
                    <div id="getstarted">
                        <button class="getstarted" onclick="openForm()">Get Started</button><br>
                        <button class="login" id="login" onclick="window.location.href = '<?php echo base_url('Home/login'); ?>';">Log
                            In</button><br>
                    </div>
